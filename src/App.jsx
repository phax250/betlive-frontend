...
const css = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .cam-iframe{width:100%;height:100%;border:none;position:absolute;top:0;left:0}
`;

// ─── VRAIES CAMÉRAS LIVE ──────────────────────────────────────────────────────
// Sources : YouTube Live (embed public), Windy webcams (embed public)
const CAMERAS = [
  {
    id: 1,
    ...
    location: "🇺🇸 New York",
    type: "youtube",
    // Times Square live 24/7 - chaîne officielle Times Square
  ...
  },
  {
    ...
    type: "youtube",
    // Shibuya live 24/7
    embedUrl: "https://www.youtube.com/embed/rINDRAhEhq8?autoplay=1&mute=1&controls=0&loop=1&playlist=rINDRAhEhq8",
    active: true,
    timezone: "Asia/Tokyo",
  },
  {
    ...
    type: "youtube",
    // Paris live cam
    embedUrl: "https://www.youtube.com/embed/ByXc2GCVx4I?autoplay=1&mute=1&controls=0&loop=1&playlist=ByXc2GCVx4I",
    active: true,
  ...
  },
  {
    ...
    location: "🇬🇧 Londres",
    type: "youtube",
    embedUrl: "https://www.youtube.com/embed/LmmPR3e07-0?autoplay=1&mute=1&controls=0&loop=1&playlist=LmmPR3e07-0",
    active: true,
  ...
  },
  {
    ...
    location: "🇺🇸 Las Vegas",
    type: "youtube",
    embedUrl: "https://www.youtube.com/embed/NyWGcFbzgDQ?autoplay=1&mute=1&controls=0&loop=1&playlist=NyWGcFbzgDQ",
    active: true,
    timezone: "America/Los_Angeles",
  },
  {
    id: 6,
    name: "Sydney Harbour — Australie",
    location: "🇦🇺 Sydney",
    type: "youtube",
    embedUrl: "https://www.youtube.com/embed/RnN-6M9Ij7I?autoplay=1&mute=1&controls=0&loop=1&playlist=RnN-6M9Ij7I",
    active: false,
...
const T = {
  fr: {
    ...
    playNow:"JOUER MAINTENANT",howIt:"COMMENT ÇA MARCHE ?",
    step1t:"Caméra en direct",step1d:"Une vraie caméra filme une rue en temps réel.",
    ...
    recentWins:"GAINS RÉCENTS",joinNow:"REJOINDRE MAINTENANT",
    community:"COMMUNAUTÉ",topPlayers:"TOP JOUEURS",recentActivity:"ACTIVITÉ RÉCENTE",
    totalWon:"Total gagné",totalBets:"Paris joués",winRate:"Taux de victoire",
    tabs:{home:"🏠 Accueil",bet:"🎯 Paris",community:"👥 Communauté",cameras:"📡 Caméras",admin:"⚙️ Admin"},
    deposit:"DÉPÔT",crypto:"CRYPTO",copyAddr:"Copier l'adresse",copied:"Copié !",
    roundOpen:"PARIS OUVERTS",roundClose:"FERMETURE",roundAI:"ANALYSE IA…",roundResult:"RÉSULTATS",
    placeBet:"PLACER LE PARI",cancel:"Annuler",betSlip:"BULLETIN",potential:"Gain potentiel",
    stake:"MISE (coins)",inProgress:"EN COURS",confirm:"CONFIRMER",nextRound:"PROCHAIN ROUND →",
    won:"GAGNÉ !",lost:"PERDU",login:"SE CONNECTER",register:"S'INSCRIRE",lang:"🌐 Langue",
    liveCam:"CAMÉRA LIVE",selectCam:"Choisir une caméra",
    camInfo:"Cette caméra est en direct 24h/24 depuis",
  },
  en: {
    tagline:"Bet on the real world, live.",
    subtitle:"Cameras from around the world. Real events. Instant wins.",
    playNow:"PLAY NOW",howIt:"HOW IT WORKS",
    step1t:"Live Camera",step1d:"A real camera films a street in real time.",
    ...
    recentWins:"RECENT WINS",joinNow:"JOIN NOW",
    community:"COMMUNITY",topPlayers:"TOP PLAYERS",recentActivity:"RECENT ACTIVITY",
    totalWon:"Total won",totalBets:"Bets placed",winRate:"Win rate",
    tabs:{home:"🏠 Home",bet:"🎯 Bet",community:"👥 Community",cameras:"📡 Cameras",admin:"⚙️ Admin"},
    deposit:"DEPOSIT",crypto:"CRYPTO",copyAddr:"Copy address",copied:"Copied!",
    roundOpen:"BETS OPEN",roundClose:"CLOSING",roundAI:"AI SCANNING…",roundResult:"RESULTS",
    placeBet:"PLACE BET",cancel:"Cancel",betSlip:"BET SLIP",potential:"Potential win",
    stake:"STAKE (coins)",inProgress:"IN PROGRESS",confirm:"CONFIRM",nextRound:"NEXT ROUND →",
    won:"WON!",lost:"LOST",login:"LOG IN",register:"REGISTER",lang:"🌐 Language",
    liveCam:"LIVE CAMERA",selectCam:"Select camera",
    camInfo:"This camera is live 24/7 from",
  },
  es: {
    tagline:"Apuesta al mundo real, en vivo.",
    subtitle:"Cámaras de todo el mundo. Eventos reales. Ganancias instantáneas.",
    playNow:"JUGAR AHORA",howIt:"¿CÓMO FUNCIONA?",
    step1t:"Cámara en vivo",step1d:"Una cámara real filma una calle en tiempo real.",
    ...
    recentWins:"GANANCIAS RECIENTES",joinNow:"ÚNETE AHORA",
    community:"COMUNIDAD",topPlayers:"TOP JUGADORES",recentActivity:"ACTIVIDAD RECIENTE",
    totalWon:"Total ganado",totalBets:"Apuestas",winRate:"Tasa de victoria",
    tabs:{home:"🏠 Inicio",bet:"🎯 Apostar",community:"👥 Comunidad",cameras:"📡 Cámaras",admin:"⚙️ Admin"},
    deposit:"DEPÓSITO",crypto:"CRIPTO",copyAddr:"Copiar dirección",copied:"¡Copiado!",
    roundOpen:"APUESTAS ABIERTAS",roundClose:"CIERRE",roundAI:"IA ANALIZANDO…",roundResult:"RESULTADOS",
    placeBet:"APOSTAR",cancel:"Cancelar",betSlip:"BOLETO",potential:"Ganancia potencial",
    stake:"APUESTA (coins)",inProgress:"EN CURSO",confirm:"CONFIRMAR",nextRound:"SIGUIENTE →",
    won:"¡GANASTE!",lost:"PERDISTE",login:"INICIAR SESIÓN",register:"REGISTRARSE",lang:"🌐 Idioma",
    liveCam:"CÁMARA EN VIVO",selectCam:"Seleccionar cámara",
    camInfo:"Esta cámara está en vivo 24h/7 desde",
  },
};
...
// ─── COMPOSANT CAMÉRA LIVE ────────────────────────────────────────────────────
function LiveCameraPlayer({camera,compact=false}){
  const [loaded,setLoaded]=useState(false);
  const [error,setError]=useState(false);

  return(
    <div style={{position:"relative",width:"100%",height:"100%",background:"#000",borderRadius:compact?8:0,overflow:"hidden"}}>
      {!loaded&&!error&&(
        <div style={{position:"absolute",inset:0,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:12,zIndex:2}}>
          ...
          <span style={{fontFamily:"'DM Mono',monospace",fontSize:11,color:"var(--muted)"}}>Chargement du flux live...</span>
        </div>
      )}
      {error&&(
        <div style={{position:"absolute",inset:0,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:8,zIndex:2,background:"rgba(0,0,0,0.8)"}}>
          <span style={{fontSize:28}}>📡</span>
          <span style={{fontFamily:"'DM Mono',monospace",fontSize:11,color:"var(--muted)",textAlign:"center",padding:"0 20px"}}>Flux temporairement indisponible</span>
        </div>
      )}
      <iframe
        src={camera.embedUrl}
        ...
        style={{opacity:loaded?1:0,transition:"opacity 0.5s",border:"none",width:"100%",height:"100%"}}
        title={camera.name}
      />
    </div>
  );
      ...
      <div style={{display:"flex",gap:40,animation:"ticker 40s linear infinite",whiteSpace:"nowrap"}}>
        {d.map((h,i)=>(
          <span key={i} style={{fontFamily:"'DM Mono',monospace",fontSize:10,color:h.won?"var(--green)":"var(--muted)",flexShrink:0}}>
            {h.won?"✅":"❌"} {h.user||"Joueur"} · {h.label} · {h.won?`+${h.gain?.toFixed(0)}`:`-${h.stake}`} coins
          </span>
        ))}
      </div>
    </div>
  ...
  return(
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.88)",zIndex:200,display:"flex",alignItems:"center",justifyContent:"center",backdropFilter:"blur(6px)"}}>
      <div style={{background:"var(--card)",border:`2px solid ${net>=0?"var(--green)":"var(--red)"}`,borderRadius:20,padding:30,maxWidth:420,width:"90%",animation:"glow-in 0.3s ease"}}>
        ...
        <button onClick={onClose} style={{width:"100%",padding:12,borderRadius:10,border:"none",background:"linear-gradient(135deg,var(--accent),#0090a8)",color:"#000",fontFamily:"'Syne',sans-serif",fontWeight:700,fontSize:13,cursor:"pointer"}}>{t.nextRound}</button>
      </div>
    </div>
  );
}

function CryptoModal({t,onClose,onDeposit}){
    ...
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.88)",zIndex:300,display:"flex",alignItems:"center",justifyContent:"center",backdropFilter:"blur(6px)"}}>
      <div style={{background:"var(--card)",border:"1px solid var(--border)",borderRadius:20,padding:28,maxWidth:400,width:"90%",animation:"glow-in 0.3s ease"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:18}}>
          <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:22,letterSpacing:2}}>{t.crypto} {t.deposit}</div>
          <button onClick={onClose} style={{background:"none",border:"none",color:"var(--muted)",cursor:"pointer",fontSize:18}}>✕</button>
        </div>
        {step==="choose"&&(
          <div style={{display:"flex",flexDirection:"column",gap:8}}>
            {CRYPTO_OPTIONS.map(c=>(
              <button key={c.id} onClick={()=>{setSel(c);setStep("pay");}} style={{display:"flex",alignItems:"center",gap:12,padding:"12px 14px",background:"var(--surface)",border:"1px solid var(--border)",borderRadius:10,cursor:"pointer",textAlign:"left"}}>
        ...
        {step==="pay"&&sel&&(
          <>
            <div style={{background:"var(--surface)",border:"1px solid var(--border)",borderRadius:10,padding:10,marginBottom:12,fontFamily:"'DM Mono',monospace",fontSize:10,color:"var(--accent)",wordBreak:"break-all"}}>{sel.addr}</div>
            ...
            <input type="number" value={amount} onChange={e=>setAmount(e.target.value)} style={{width:"100%",background:"var(--surface)",border:"1px solid var(--border)",borderRadius:8,padding:"9px",color:"var(--text)",fontFamily:"'DM Mono',monospace",fontSize:12,outline:"none",marginBottom:10}}/>
            <div style={{fontSize:10,color:"var(--gold)",marginBottom:14,fontFamily:"'DM Mono',monospace"}}>≈ {Math.round(parseFloat(amount||0)*100000)} coins crédités</div>
            <div style={{display:"flex",gap:8}}>
              <button onClick={()=>setStep("choose")} style={{flex:1,padding:"10px",border:"1px solid var(--border)",background:"transparent",color:"var(--muted)",borderRadius:9,cursor:"pointer",fontFamily:"'Syne',sans-serif",fontWeight:600,fontSize:12}}>← Retour</button>
              <button onClick={()=>{onDeposit(parseFloat(amount||0),sel);onClose();}} style={{flex:2,padding:"10px",border:"none",background:"var(--accent)",color:"#000",borderRadius:9,cursor:"pointer",fontFamily:"'Syne',sans-serif",fontWeight:700,fontSize:12}}>{t.confirm} →</button>
            </div>
          </>
        )}
      </div>
...
// ─── PAGE CAMÉRAS ─────────────────────────────────────────────────────────────
function CamerasPage({t,setCam,setTab}){
  const [preview,setPreview]=useState(null);
  return(
    <div style={{gridColumn:"1/-1",animation:"glow-in 0.4s ease"}}>
      <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:28,letterSpacing:3,marginBottom:4}}>{t.tabs.cameras}</div>
      <div style={{fontSize:11,color:"var(--muted)",marginBottom:20}}>Flux live 24h/24 depuis les plus grandes villes du monde</div>

      {/* Prévisualisation */}
      {preview&&(
        <div style={{marginBottom:16,borderRadius:14,overflow:"hidden",border:`2px solid var(--accent)`,aspectRatio:"16/9",position:"relative",animation:"glow-in 0.3s ease"}}>
          <LiveCameraPlayer camera={preview}/>
          <div style={{position:"absolute",top:10,left:10,display:"flex",gap:8,alignItems:"center",zIndex:3}}>
            <LiveBadge/>
            <span style={{background:"rgba(0,0,0,0.7)",padding:"2px 9px",borderRadius:20,fontSize:10,fontFamily:"'DM Mono',monospace",backdropFilter:"blur(4px)"}}>{preview.location} — {preview.name}</span>
          </div>
          <button onClick={()=>{setCam(preview);setTab("bet");}} style={{position:"absolute",bottom:12,right:12,background:"var(--accent)",border:"none",color:"#000",fontFamily:"'Syne',sans-serif",fontWeight:700,fontSize:12,padding:"8px 16px",borderRadius:8,cursor:"pointer",zIndex:3}}>
            PARIER SUR CETTE CAM →
          </button>
        </div>
      )}
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(280px,1fr))",gap:12}}>
        {CAMERAS.map(c=>(
          <div key={c.id}
            style={{position:"relative",borderRadius:12,overflow:"hidden",border:`2px solid ${preview?.id===c.id?"var(--accent)":"var(--border)"}`,aspectRatio:"16/9",background:"#000",cursor:"pointer",transition:"border-color 0.2s"}}
            onClick={()=>setPreview(preview?.id===c.id?null:c)}>
            {/* Miniature avec iframe */}
            {preview?.id===c.id?(
              <LiveCameraPlayer camera={c} compact/>
            ):(
              <div style={{width:"100%",height:"100%",background:"linear-gradient(135deg,#0e1420,#131a27)",display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column",gap:8}}>
                <span style={{fontSize:32}}>📡</span>
                <span style={{fontFamily:"'DM Mono',monospace",fontSize:10,color:"var(--muted)"}}>Cliquer pour prévisualiser</span>
              </div>
            )}
            <div style={{position:"absolute",inset:0,background:"linear-gradient(to bottom,transparent 50%,rgba(0,0,0,0.85))",pointerEvents:"none"}}/>
            <div style={{position:"absolute",bottom:10,left:10,pointerEvents:"none"}}>
              <div style={{fontWeight:700,fontSize:12,color:"var(--text)"}}>{c.name}</div>
              <div style={{fontSize:10,color:"var(--muted)"}}>{c.location}</div>
            </div>
            <div style={{position:"absolute",top:9,right:9,pointerEvents:"none"}}>
              {c.active?<LiveBadge/>:<span style={{background:"rgba(0,0,0,0.7)",padding:"2px 7px",borderRadius:4,fontSize:9,color:"var(--muted)",fontFamily:"'DM Mono',monospace"}}>HORS LIGNE</span>}
            </div>
          </div>
        ))}
      </div>
...
function CommunityPage({t}){
  ...
  return(
    <div style={{gridColumn:"1/-1",animation:"glow-in 0.4s ease"}}>
      <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:28,letterSpacing:3,marginBottom:20}}>{t.community}</div>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:8}}>
            {MOCK_PLAYERS.map((p,i)=>(
              <div key={p.id} onClick={()=>setActivePlayer(activePlayer?.id===p.id?null:p)}
                style={{background:"var(--card)",border:`1px solid ${activePlayer?.id===p.id?"var(--accent)":"var(--border)"}`,borderRadius:12,padding:14,cursor:"pointer",display:"flex",alignItems:"center",gap:12}}>
                ...
                <div style={{flex:1,minWidth:0}}>
                  <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:2}}>
                    ...
                    <span>{p.country}</span><span style={{fontSize:12}}>{p.badge}</span>
                  </div>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:12}}>
          {activePlayer?(
            <div style={{background:"var(--card)",border:"1px solid var(--accent)",borderRadius:14,padding:20,animation:"glow-in 0.3s ease"}}>
              <div style={{display:"flex",alignItems:"center",gap:14,marginBottom:16}}>
                ...
                <div>
                  <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:22,letterSpacing:1}}>{activePlayer.name} {activePlayer.country}</div>
          ...
          <div style={{background:"var(--card)",border:"1px solid var(--border)",borderRadius:14,padding:16,flex:1}}>
            <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:16,letterSpacing:2,marginBottom:12}}>{t.recentActivity}</div>
            <div style={{display:"flex",flexDirection:"column",gap:6,maxHeight:300,overflowY:"auto"}}>
              {MOCK_FEED.map((f,i)=>(
                <div key={i} style={{display:"flex",alignItems:"center",gap:10,padding:"8px 10px",background:"var(--surface)",borderRadius:8,border:`1px solid ${f.won===true?"rgba(0,230,118,0.15)":f.won===false?"rgba(255,59,92,0.1)":"var(--border)"}`}}>
...
function HomePage({t,onPlay,profile}){
  return(
    <div style={{gridColumn:"1/-1",animation:"glow-in 0.4s ease"}}>
      {/* HERO */}
      <div style={{position:"relative",borderRadius:20,overflow:"hidden",marginBottom:24,minHeight:380,display:"flex",alignItems:"center",background:"var(--card)",border:"1px solid var(--border)"}}>
        {/* Live cam en fond */}
        <div style={{position:"absolute",inset:0,opacity:0.3}}>
          <LiveCameraPlayer camera={CAMERAS[0]}/>
        </div>
        <div style={{position:"absolute",inset:0,background:"linear-gradient(135deg,rgba(8,11,16,0.95) 40%,rgba(0,229,255,0.05))"}}/>
        <div style={{position:"absolute",inset:0,backgroundImage:"linear-gradient(var(--border) 1px,transparent 1px),linear-gradient(90deg,var(--border) 1px,transparent 1px)",backgroundSize:"40px 40px",opacity:0.1}}/>
        <div style={{position:"relative",padding:"40px 48px",maxWidth:600}}>
          ...
          <h1 style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:58,letterSpacing:3,lineHeight:1.05,marginBottom:16}}>
            {t.tagline.split(" ").map((w,i)=>
              ["réel,","real,","vivo.","real."].includes(w)
                ?<span key={i} style={{color:"var(--accent)"}}>{w} </span>
                :<span key={i}>{w} </span>
            )}
          </h1>
          <p style={{fontSize:14,color:"var(--muted)",marginBottom:28,lineHeight:1.6}}>{t.subtitle}</p>
          <div style={{display:"flex",gap:12}}>
            <button onClick={onPlay} style={{background:"linear-gradient(135deg,var(--accent),#0090a8)",color:"#000",border:"none",borderRadius:9,padding:"12px 24px",fontFamily:"'Syne',sans-serif",fontWeight:700,fontSize:13,cursor:"pointer"}}>{t.playNow} 🚀</button>
            <button style={{background:"transparent",border:"1px solid var(--border)",color:"var(--muted)",borderRadius:9,padding:"12px 20px",fontFamily:"'Syne',sans-serif",fontWeight:600,fontSize:13,cursor:"pointer"}}>{t.howIt}</button>
          </div>
        </div>
        {/* Mini cams preview */}
        <div style={{position:"absolute",right:40,top:"50%",transform:"translateY(-50%)",width:200,display:"flex",flexDirection:"column",gap:8}}>
          {CAMERAS.filter(c=>c.active).slice(0,2).map(c=>(
            <div key={c.id} style={{position:"relative",borderRadius:10,overflow:"hidden",border:"1px solid var(--border)",aspectRatio:"16/9",background:"#000"}}>
              ...
              <div style={{position:"absolute",top:5,left:5,pointerEvents:"none"}}><LiveBadge/></div>
              <div style={{position:"absolute",bottom:5,left:8,fontSize:9,fontFamily:"'DM Mono',monospace",color:"var(--text)",pointerEvents:"none"}}>{c.location}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:12,marginBottom:24}}>
        {[
          {label:"Joueurs actifs",value:"12,847",icon:"👥",color:"var(--accent)"},
          {label:"Paris joués",value:"3,241,092",icon:"🎯",color:"var(--gold)"},
          {label:"Gains versés",value:"4.2M coins",icon:"💰",color:"var(--green)"},
        ].map((s,i)=>(
      ...
      <div style={{background:"var(--card)",border:"1px solid var(--border)",borderRadius:16,padding:24,marginBottom:24}}>
        <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:20,letterSpacing:3,marginBottom:18,color:"var(--accent)"}}>{t.howIt}</div>
        <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:14}}>
          {[
            ...
            <div key={i} style={{textAlign:"center",padding:"16px 10px",background:"var(--surface)",borderRadius:12,border:`1px solid ${s.color}30`,position:"relative"}}>
              <div style={{position:"absolute",top:-1,left:"50%",transform:"translateX(-50%)",width:22,height:22,borderRadius:"50%",background:s.color,display:"flex",alignItems:"center",justifyContent:"center",fontSize:10,fontWeight:700,color:"#000",fontFamily:"'DM Mono',monospace"}}>{i+1}</div>
              <div style={{fontSize:28,marginBottom:6,marginTop:6}}>{s.icon}</div>
              <div style={{fontWeight:700,fontSize:12,color:s.color,marginBottom:4}}>{s.title}</div>
      ...
      <div style={{marginBottom:24}}>
        <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:20,letterSpacing:3,marginBottom:12}}>{t.recentWins}</div>
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:10}}>
          {MOCK_WINS.map((w,i)=>(
            <div key={i} style={{background:"var(--card)",border:"1px solid rgba(0,230,118,0.2)",borderRadius:12,padding:14,display:"flex",alignItems:"center",gap:10}}>
              <div style={{width:38,height:38,borderRadius:"50%",background:"rgba(0,230,118,0.1)",border:"1px solid rgba(0,230,118,0.3)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,flexShrink:0}}>{w.flag}</div>
              <div style={{flex:1,minWidth:0}}>
                <div style={{fontWeight:700,fontSize:11,marginBottom:1,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{w.user}</div>
                <div style={{fontSize:9,color:"var(--muted)",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{w.bet}</div>
              </div>
              <div style={{textAlign:"right",flexShrink:0}}>
                <div style={{fontFamily:"'DM Mono',monospace",color:"var(--green)",fontWeight:700,fontSize:14}}>+{w.amount.toLocaleString()}</div>
      ...
      <div style={{background:"linear-gradient(135deg,rgba(0,229,255,0.08),rgba(245,200,66,0.05))",border:"1px solid rgba(0,229,255,0.2)",borderRadius:16,padding:"28px 32px",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
        <div>
          <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:26,letterSpacing:2,marginBottom:4}}>{t.joinNow}</div>
          <div style={{fontSize:11,color:"var(--muted)"}}>5 000 coins offerts à l'inscription • Dépôt crypto disponible</div>
        </div>
        <div style={{display:"flex",gap:10}}>
          <button style={{background:"transparent",border:"1px solid var(--border)",color:"var(--muted)",borderRadius:9,padding:"10px 20px",fontFamily:"'Syne',sans-serif",fontWeight:600,fontSize:12,cursor:"pointer"}}>{t.login}</button>
          <button style={{background:"linear-gradient(135deg,var(--gold),#c8a000)",color:"#000",border:"none",borderRadius:9,padding:"10px 22px",fontFamily:"'Syne',sans-serif",fontWeight:700,fontSize:12,cursor:"pointer"}}>{t.register} →</button>
        </div>
      </div>
    </div>
  );
    ...
    <>
      ...
      <div style={{minHeight:"100vh",display:"flex",flexDirection:"column"}}>
        ...
        <header style={{background:"var(--surface)",borderBottom:"1px solid var(--border)",padding:"0 20px",height:54,display:"flex",alignItems:"center",justifyContent:"space-between",position:"sticky",top:0,zIndex:50}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:8}}>
            ...
            <div style={{position:"relative"}}>
              <button onClick={()=>setShowLang(v=>!v)} style={{background:"var(--card)",border:"1px solid var(--border)",borderRadius:8,padding:"5px 10px",color:"var(--muted)",cursor:"pointer",fontFamily:"'DM Mono',monospace",fontSize:10}}>{t.lang}</button>
              {showLang&&(
            ...
            <button onClick={()=>setShowCrypto(true)} style={{background:"linear-gradient(135deg,var(--gold),#c8a000)",color:"#000",border:"none",borderRadius:8,padding:"7px 12px",fontFamily:"'Syne',sans-serif",fontWeight:700,fontSize:11,cursor:"pointer"}}>₿ {t.deposit}</button>
          </div>
        </header>
        ...
        <main style={{flex:1,display:"grid",gridTemplateColumns:tab==="bet"?"1fr 320px":"1fr",gap:0,maxWidth:1200,width:"100%",margin:"0 auto",padding:16,boxSizing:"border-box"}}>
          ...
          {tab==="cameras"&&<CamerasPage t={t} setCam={setCam} setTab={setTab}/>}

          {tab==="admin"&&(
            <div style={{gridColumn:"1/-1"}}>
              <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:28,letterSpacing:3,marginBottom:4}}>⚙️ ADMIN PANEL</div>
              <div style={{fontSize:11,color:"var(--muted)",marginBottom:16}}>Profil IA actuel : {profile.icon} {profile.name} · {profile.day} {profile.time} · Round {dur}s · Intensité {Math.round(profile.intensity*100)}%</div>
              <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(180px,1fr))",gap:8}}>
                {[
                  ...
                  return(
                    <div key={i} style={{background:"var(--card)",border:`1px solid ${isActive?p.color:"var(--border)"}`,borderRadius:9,padding:10,opacity:isActive?1:0.65}}>
                      <div style={{display:"flex",alignItems:"center",gap:7,marginBottom:6}}><span style={{fontSize:16}}>{p.icon}</span><div><div style={{fontSize:10,fontWeight:700,color:p.color}}>{p.name}</div><div style={{fontSize:8,color:"var(--muted)",fontFamily:"'DM Mono',monospace"}}>{p.hours}</div></div></div>
                      <div style={{height:3,background:"var(--border)",borderRadius:2,overflow:"hidden",marginBottom:4}}><div style={{height:"100%",width:`${p.intensity*100}%`,background:p.color,borderRadius:2}}/></div>
                      ...
                      {isActive&&<div style={{marginTop:4,textAlign:"center",fontSize:8,color:p.color,fontFamily:"'DM Mono',monospace"}}>▶ ACTIF</div>}
                    </div>
                  );
                })}
              </div>
            ...
            <>
              ...
              <div style={{paddingRight:14,display:"flex",flexDirection:"column",gap:12}}>
                ...
                <div style={{background:`linear-gradient(135deg,${profile.color}18,transparent)`,border:`1px solid ${profile.color}40`,borderRadius:12,padding:"10px 14px",display:"flex",alignItems:"center",gap:12}}>
                  ...
                  <div style={{flex:1}}>
                    <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:3}}>
                      <span style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:15,letterSpacing:1,color:profile.color}}>{profile.name}</span>
                ...
                <div style={{display:"flex",gap:8,overflowX:"auto",paddingBottom:4}}>
                  {CAMERAS.filter(c=>c.active).map(c=>(
                    <button key={c.id} onClick={()=>setCam(c)}
                      style={{flexShrink:0,padding:"5px 12px",border:`1px solid ${cam.id===c.id?"var(--accent)":"var(--border)"}`,background:cam.id===c.id?"rgba(0,229,255,0.08)":"var(--surface)",borderRadius:8,cursor:"pointer",fontFamily:"'DM Mono',monospace",fontSize:10,color:cam.id===c.id?"var(--accent)":"var(--muted)",transition:"all 0.2s"}}>
                      {c.location} {c.name.split("—")[0]}
                    </button>
                  ))}
                </div>

                {/* VRAIE CAMÉRA LIVE */}
                <div style={{position:"relative",borderRadius:14,overflow:"hidden",border:`2px solid ${cam.id?`${profile.color}60`:"var(--border)"}`,aspectRatio:"16/9",background:"#000"}}>
                  <LiveCameraPlayer camera={cam}/>
                  {/* Overlay infos */}
                  ...
                  <div style={{position:"absolute",top:10,right:10,background:`${profile.color}25`,border:`1px solid ${profile.color}70`,borderRadius:7,padding:"3px 9px",fontFamily:"'DM Mono',monospace",fontSize:9,color:profile.color,backdropFilter:"blur(4px)",letterSpacing:1,zIndex:3,pointerEvents:"none"}}>
                    {profile.icon} {phaseLabel}
                  </div>
                  {aiLog[0]&&(
                    <div style={{position:"absolute",bottom:10,left:10,right:10,background:"rgba(0,0,0,0.75)",backdropFilter:"blur(8px)",borderRadius:8,padding:"5px 9px",fontFamily:"'DM Mono',monospace",fontSize:10,color:"var(--accent)",border:"1px solid rgba(0,229,255,0.2)",animation:"glow-in 0.3s ease",zIndex:3,pointerEvents:"none"}}>
                      {aiLog[0]}
                    </div>
                  )}
                ...
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:10}}>
                  {BET_CONFIG.map(cfg=>(
                    <BetCard key={cfg.type} cfg={cfg} phase={phase} profile={profile} selectedBet={selBet} onSelect={handleSelect} placedBets={placedBets}/>
                  ))}
                </div>
              </div>
                ...
                <div style={{background:"var(--card)",border:"1px solid var(--border)",borderRadius:12,padding:14,flex:1}}>
                  ...
                  {selBet?(
                    <div style={{animation:"glow-in 0.3s ease"}}>
                      ...
                      <button onClick={handlePlace} style={{width:"100%",padding:11,borderRadius:9,border:"none",background:"linear-gradient(135deg,var(--accent),#0090a8)",color:"#000",fontFamily:"'Syne',sans-serif",fontWeight:700,fontSize:12,cursor:"pointer",marginBottom:5,letterSpacing:1}}>{t.placeBet}</button>
                      <button onClick={()=>setSelBet(null)} style={{width:"100%",padding:6,borderRadius:7,border:"1px solid var(--border)",background:"transparent",color:"var(--muted)",fontFamily:"'Syne',sans-serif",fontSize:10,cursor:"pointer"}}>{t.cancel}</button>
                    </div>
                  ):(
        ...
        {showCrypto&&<CryptoModal t={t} onClose={()=>setShowCrypto(false)} onDeposit={(amt,crypto)=>{setCoins(c=>c+Math.round(amt*100000));}}/>}
        ...
        {phase==="showResult"&&placedBets.length===0&&(
          <div style={{position:"fixed",bottom:18,right:18,background:"var(--card)",border:"1px solid var(--border)",borderRadius:11,padding:"9px 14px",zIndex:50,animation:"glow-in 0.3s ease",fontFamily:"'DM Mono',monospace",fontSize:10,color:"var(--muted)",display:"flex",alignItems:"center",gap:10}}>
            ...
            <button onClick={closeResult} style={{background:"var(--accent)",border:"none",color:"#000",borderRadius:5,padding:"2px 7px",cursor:"pointer",fontSize:9,fontWeight:700}}>{t.nextRound}</button>
          </div>
        )}
      </div>
    </>
